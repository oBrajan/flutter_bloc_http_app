...
class GetOverallMetricsUseCase
    extends UseCaseData<AppResult, OverallMetricsParams> {
  DashboardRepository _repository = sl<DashboardRepository>();

  @override
  Future<AppResult> execute(OverallMetricsParams params) async {
    return await _repository.getOverallMetrics(
      params.accountId,
      params.projectId,
      params.topicId,
      params.timePeriod,
...
class OverallMetricsParams extends Equatable {
  final String accountId;
  final String projectId;
  final String topicId;
  final String timePeriod;

  OverallMetricsParams({
